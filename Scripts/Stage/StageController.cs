...
namespace OctoberStudio
{
    public class StageController : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            if (spawner != null)
            {
                spawner.OnEnemyKilled.AddListener(OnEnemyKilled);
            }
    
            // NEW: Reset equipment drops for new stage
            dropManager.ResetEquipmentDrops();
        ...
        private void OnEnemyKilled(EnemyBehavior enemy, Vector3 deathPosition)
        {
            int stageLevel = stageSave.SelectedStageId + 1;
            dropManager.TryDropEquipment(deathPosition, enemy.IsBoss, stageLevel);
        ...
        private void OnDisable()
        {
            ...
            if (spawner != null)
            {
                spawner.OnEnemyKilled.RemoveListener(OnEnemyKilled);
            }
        }
